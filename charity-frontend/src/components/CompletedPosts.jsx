...
const CompletedPosts = () => {
    ...
    const [completedTransactions, setCompletedTransactions] = useState({}); // ✅ Track completed transactions
    ...
    const handleTransactionSuccess = (postId) => {
        setCompletedTransactions((prev) => ({ ...prev, [postId]: true }));
    };
    ...
    return (
        <div>
            ...
            <div className="container mt-4">
                <h3 className="text-center fw-bold mb-4 text-success">COMPLETED POSTS</h3>
                            ...
                            <div key={post._id} className="col-md-4 mb-4">
                                <div className="card shadow-sm border-success">
                                    <div className="card-body">
                                        ...
                                        {completedTransactions[post._id] ? (
                                            <p className="text-success fw-bold">✅ Transaction Successful</p>
                                        ) : (
                                            <button
            ...
            {selectedPost && (
                <TransactionModal 
                    ...
                    post={selectedPost} 
                    onTransactionSuccess={handleTransactionSuccess} // ✅ Pass function to modal
                />
            )}
        </div>
    );

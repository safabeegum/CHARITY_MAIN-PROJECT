...
import { faHome, faUsers, faHandsHelping, faFileAlt, faComments, faUser } from '@fortawesome/free-solid-svg-icons';
                  ...
                  <div className="card-body">
                    ...
                    <div className="progress mt-2">
                      <div 
                        ...
                        role="progressbar" 
                        style={{ width: `${(post.currentDonationsReceived / post.requiredAmount) * 100}%` }}
                      >
                        {Math.round((post.currentDonationsReceived / post.requiredAmount) * 100)}%
                      </div>
                    </div>
                    <p className="text-center mt-1">
                       <strong>Collected:</strong> ₹{post.currentDonationsReceived} / ₹{post.requiredAmount}
                    </p>
                    <div className="mt-2">

...
const Review = () => {
    ...
    useEffect(() => {
        // Debugging: Check if token exists in session storage
    ...
    const readValues = async (event) => {
        ...
        try {
            ...
            if (response.data.status === "Success") {
                ...
                setInput({ review: "", rating: 0 }); // Reset form
            } else {
    ...
    const styles = {
        ...
        star: { fontSize: '35px', cursor: 'pointer', marginRight: '8px', color: 'gray', transition: 'color 0.3s' },
                        ...
                        <div className="card mb-3">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    <img src="https://cdn.botpenguin.com/assets/website/User_Feedback_d4677ac183.png" className="img-fluid rounded-start" alt="Feedback" />
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body">
                                        ...
                                        {/* ⭐ Star Rating System Below the Textarea */}
                                        <div style={styles.starContainer}>
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <span 
                                                    key={star} 
                                                    style={star <= input.rating ? { ...styles.star, ...styles.starSelected } : styles.star} 
                                        ...
                                        <br />
                                        <button onClick={readValues} className="btn btn-primary">Submit your Review</button>
                                    </div>
                                </div>
                            </div>
                        </div>

...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const response = await axios.post(
          "http://localhost:3030/api/admindashboard"
        );
    ...
    const fetchUserActivity = async () => {
      try {
        const response = await axios.post(
          "http://localhost:3030/api/useractivity"
        );
    ...
    const fetchTransactionActivity = async () => {
      try {
        const response = await axios.post(
          "http://localhost:3030/api/transactionactivity"
        );
        ...
        <div className="col-sm-3 bg-white text-dark p-3 min-vh-100 border-end">
          <ul className="nav flex-column">
            {[
              ...
              {
                href: "/managesocialworkers",
                icon: faHandsHelping,
                label: "MANAGE SOCIAL WORKERS",
              },
              {
                href: "/pendingposts",

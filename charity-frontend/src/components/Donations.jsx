            ...
            <Container className="mt-4">
                ...
                <Table striped bordered hover>
                    ...
                    <tbody>
                        {donations.length === 0 ? (
                            <tr>
                                <td colSpan="8" className="text-center">No donations found</td>
                            </tr>
                        ) : (
                            donations.map((donation, index) => (
                                <tr key={donation._id}>
                                    ...
                                    <td>{donation.postId?._id || "Unknown Post ID"}</td> {/* ✅ Display postId */}
                                    <td>₹{donation.amount}</td>
                                    <td>{donation.method}</td>
                                    <td className={donation.status === "pending" ? "text-warning" : "text-success"}>
                                        {donation.status}
                                    </td>
